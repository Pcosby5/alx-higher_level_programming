...
class Rectangle(Base):
    ...
    def validate_attributes(self, name:  str, value: object, greater_equal=False):
    ...
    def width(self, width: int):
        """width setter
        """
        self.validate_attributes('width', width)
        self.__width = width
    ...
    def height(self, height: int):
        """height setter
        """
        self.validate_attributes('height', height)
    ...
    def x(self, x: int):
        """x setter
        """
        self.validate_attributes('x', x, True)
        self.__x = x
    ...
    def y(self, y: int):
        """y setter
        """
        self.validate_attributes('y', y, True)
        self.__y = y
